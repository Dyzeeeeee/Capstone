<template>
    <div class="py-5 bg-darka hero-header mb-5">
        <div class="container my-5 py-5">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="display-3 text-white animated slideInLeft">Lez go to<br>Anahaw guys</h1>
                ...
                <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                    <img class="img-fluid" src="@/assets/img/sun.png" alt="" style="height: 600px;">
                </div>
            </div>
        </div>
    </div>
